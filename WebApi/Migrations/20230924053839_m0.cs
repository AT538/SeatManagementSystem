        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuildingAbbreviation = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CityAbbreviation = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CabinRoomId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FacilityId = table.Column<int>(type: "int", nullable: false),
                    EmployeeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CabinRooms", x => x.CabinRoomId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "MeetingRoomAssetAllocations",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MeetingRoomAssetAllocations", x => x.MeetingRoomAssetId);
                    table.ForeignKey(
                        name: "FK_MeetingRoomAssetAllocations_Assets_AssetId",
                        column: x => x.AssetId,
                        principalTable: "Assets",
                        principalColumn: "AssetId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MeetingRoomAssetAllocations_MeetingRooms_MeetingRoomId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MeetingRoomAssetAllocations_AssetId",
                table: "MeetingRoomAssetAllocations",
                column: "AssetId");

            migrationBuilder.CreateIndex(
                name: "IX_MeetingRoomAssetAllocations_MeetingRoomId",
                table: "MeetingRoomAssetAllocations",
